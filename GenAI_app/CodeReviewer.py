...
In the 'Bug Report' section, mention the name of the error, the corresponding errenous part in the given code and a brief description about the error. 
By the name of error, I mean the standard names like 'key error', 'Name error', 'Type error' etc. 
Errors can be even spelling errors. If you recieve just one line or only few lines of code, you should point out mistakes in it although it may not be complete. 
...
The section titles shall have a comparitively higher font size, say 28.
Sometimes, the user might have already defined a variable which may be anything including a dataframe. But user may gove you some line in between as the input. Skillfully identify such things and communicate with the user and provide a sensible output. 
...
# the user may want to type or paste their code
# the user may want to upload their .py code file
